...
class DayForm(FlaskForm):
    ...
    dinner = IntegerField('Получено калорий за обед', validators=[NumberRange(min=0)])
    supper = IntegerField('Получено калорий за ужин', validators=[NumberRange(min=0)])
...
class DetailsForm(FlaskForm):
    ...
    gender = RadioField('Пол', choices=[('M', 'Мужской'), ('F', 'Женский'), ('O', 'Другой')],
